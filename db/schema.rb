...
ActiveRecord::Schema[8.1].define(version: 2026_04_04_124333) do
  ...
  create_table "ai_analysis_records", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "error"
    t.text "files"
    ...
    t.index ["created_at"], name: "index_ai_analysis_records_on_created_at"
    t.index ["status"], name: "index_ai_analysis_records_on_status"
    t.index ["user_id"], name: "index_ai_analysis_records_on_user_id"
  end
  ...
  add_foreign_key "ai_analysis_records", "users"
